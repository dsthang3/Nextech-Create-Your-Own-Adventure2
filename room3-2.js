...
async function room3Dialogue() {
    dialogueText.innerHTML = "You have entered the Second Hallway";
    await delay(1700);
    dialogueText.innerHTML = "Now you see a bathroom and a mysterious stairwell"; 
    await delay(2000);
...
function secondCollision() {
    if (horizontalNumber > 1000 && verticalNumber > 350) {
        console.log("you have hit top door");
        clearInterval(startFirstCollision);
        window.location = "room4-2-2.html";
    }
}
