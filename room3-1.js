...
dialogueText = document.querySelector(".room3Dialogue")
async function room3Dialogue() {
    dialogueText.innerHTML = "You have entered the First Hallway";
    await delay(1700);
    dialogueText.innerHTML = "Now you see a glowing throne room and a kitchen"; 
    await delay(2000);
    dialogueText.innerHTML = "Where will you go?"; 
}
...
function firstCollision() {
    if (horizontalNumber > 1000 && verticalNumber < 350) {
        ...
        window.location = "room4-1-1.html";
    }
}
function secondCollision() {
    if (horizontalNumber > 1000 && verticalNumber > 350) {
        console.log("you have hit top door");
        clearInterval(startFirstCollision);
        window.location = "room4-1-2.html";
    }
}
...
//bottom half = greater than 350
//top half is less than 350
room3Dialogue();